...
options:
  ...
  bfd_multi_hop_authentication:
    description:
    - The bidirectional forwarding detection (BFD) multi-hop authentication of the Fabric Policies Node Settings.
  ...
  bfd_multi_hop_key_id:
    description:
    - The BFD multi-hop key ID of the Fabric Policies Node Settings.
    type: int
  bfd_multi_hop_key:
    description:
    - The BFD multi-hop key of the Fabric Policies Node Settings.
    type: str
  target_dscp:
    description:
    - The DSCP Level of the Fabric Policies Node Settings.
    type: str
    choices:
      - af11
      - af12
...
def main():
    ...
    argument_spec.update(
        ...
        name=dict(type="str"),  # Fabric Policies Node Settings name
